 ...
 */
 function buildSubscription() {
    ...
    SubscriptionData.ItemList[SubscriptionData.LastIndex].id = "MaxAccelPerp";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].style = "default";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemPath = "SIMOTION";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemName = "unit/dHdGlobal.gsHMIdata.sPath.r64MaxAccelPerp";

    SubscriptionData.LastIndex = SubscriptionData.LastIndex + 1;

    SubscriptionData.ItemList[SubscriptionData.LastIndex] = new Object();

    SubscriptionData.ItemList[SubscriptionData.LastIndex].id = "AccelPerpPercent";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].style = "default";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemPath = "SIMOTION";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemName = "unit/dHdGlobal.gsHMIdata.sPath.r64AccelPerp";
...
function writeSingleVar76(id)
{    
    if(id=="MaxAccelPerp") {
    var y=document.getElementById(id).value;
    writeValueFN(y, "unit/dHdGlobal.gsHMIdata.sPath.r64MaxAccelPerp");
    } 
}
function writeSingleVar77(id)
{    
    if(id=="AccelPerpPercent") {
    var y=document.getElementById(id).value;
    writeValueFN(y, "unit/dHdGlobal.gsHMIdata.sPath.r64AccelPerp");
    } 
}