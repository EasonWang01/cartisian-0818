...
//輸出訊號
ReadValue(id_輸出訊號,var_輸出訊號);
onChangeWriteValue(id_輸出訊號,var_輸出訊號);

////////////////Y2Z2表格
ReadValue(id_y2,var_y2);
ReadValue(id_z2,var_z2);

for(i=1;i<10;i++){
	document.getElementById('y2_0'+i).addEventListener('change',function(){
		console.log(this.value)
		console.log(this.id.slice(-1))
		 writeValueFN(this.value, "unit/dHdGlobal.gsHMIdata.sStep["+this.id.slice(-1)+"].y2");
	})
}
for(i=10;i<31;i++){
	document.getElementById('y2_'+i).addEventListener('change',function(){
		
		 writeValueFN(this.value, "unit/dHdGlobal.gsHMIdata.sStep["+this.id.slice(-2)+"].y2");
	})
}
...
for(i=1;i<10;i++){
	document.getElementById('z2_0'+i).addEventListener('change',function(){
		 writeValueFN(this.value, "unit/dHdGlobal.gsHMIdata.sStep["+this.id.slice(-1)+"].z2");
	})
}
for(i=10;i<31;i++){
	document.getElementById('z2_'+i).addEventListener('change',function(){
		 writeValueFN(this.value, "unit/dHdGlobal.gsHMIdata.sStep["+this.id.slice(-2)+"].z2");
	})
}
//////////////////////////

//Q1，Q2
ReadValue(id_q1,var_q1);
ReadValue(id_q2,var_q2);


onChangeWriteValue(id_q001,var_q1);


ReadValue(id_q001,var_q1);

for(i=1;i<10;i++){
	document.getElementById('q1_0'+i).addEventListener('change',function(){
		console.log(this.value)
		console.log(this.id.slice(-1))
		 writeValueFN(this.value, "unit/dHdGlobal.gsHMIdata.sStep["+this.id.slice(-1)+"].Q1");
	})
}
for(i=10;i<31;i++){
	document.getElementById('q1_'+i).addEventListener('change',function(){
		
		 writeValueFN(this.value, "unit/dHdGlobal.gsHMIdata.sStep["+this.id.slice(-2)+"].Q1");
	})
}


for(i=1;i<10;i++){
	document.getElementById('q2_0'+i).addEventListener('change',function(){
		 writeValueFN(this.value, "unit/dHdGlobal.gsHMIdata.sStep["+this.id.slice(-1)+"].Q2");
	})
}
for(i=10;i<31;i++){
	document.getElementById('q2_'+i).addEventListener('change',function(){
		 writeValueFN(this.value, "unit/dHdGlobal.gsHMIdata.sStep["+this.id.slice(-2)+"].Q2");
	})
}
...
function writeSingleVar1(id){
    ...
    if(id=="inp_010"){
		 ...
		 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_01").style.display="none";
			document.getElementById("z2_01").style.display="none";

	 }else{

			document.getElementById("y2_01").style.display="block";
			document.getElementById("z2_01").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[1].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[1].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[1].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[1].q2");
			...
			document.getElementById("q1_01").style.display="none";
			document.getElementById("q1_001").style.display="none";

			document.getElementById("q2_01").style.display="none";
		}
			...
			document.getElementById("q1_01").style.display="block";
			
			document.getElementById("q1_001").style.display="none";

			document.getElementById("q2_01").style.display="block";
			...
			document.getElementById("q1_01").style.display="none";
			document.getElementById("q1_001").style.display="block";
...
function writeSingleVar2(id){
    ...
    if(id=="inp_020"){   
		 ...
		 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_02").style.display="none";
			document.getElementById("z2_02").style.display="none";

	 }else{
	 	document.getElementById("y2_02").style.display="block";
			document.getElementById("z2_02").style.display="block";
	 } 
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[2].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[2].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[2].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[2].q2");
			...
			document.getElementById("q1_02").style.display="none";
			document.getElementById("q1_002").style.display="none";

			document.getElementById("q2_02").style.display="none";
		}
		else if(document.getElementById(id).value=="1"){
			...
			document.getElementById("q1_02").style.display="block";
			document.getElementById("q1_002").style.display="none";

			document.getElementById("q2_02").style.display="block";
		}
		else if(document.getElementById(id).value=="4"){
			...
			document.getElementById("q1_02").style.display="none";
			document.getElementById("q1_002").style.display="block";
...
function writeSingleVar3(id){
    ...
    if(id=="inp_030"){
		 ...
		 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_03").style.display="none";
			document.getElementById("z2_03").style.display="none";

	 }else{

			document.getElementById("y2_03").style.display="block";
			document.getElementById("z2_03").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[3].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[3].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[3].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[3].q2");
			...
			document.getElementById("q1_03").style.display="none";
			document.getElementById("q1_003").style.display="none";

			document.getElementById("q2_03").style.display="none";
		}
		else if(document.getElementById(id).value=="1"){
			...
			document.getElementById("q1_03").style.display="block";
			document.getElementById("q1_003").style.display="none";

			document.getElementById("q2_03").style.display="block";
		}
		else if(document.getElementById(id).value=="4"){
			...
			document.getElementById("q1_03").style.display="none";
			document.getElementById("q1_003").style.display="block";
...
function writeSingleVar4(id){
    ...
    if(id=="inp_040"){
		 ...
		 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_04").style.display="none";
			document.getElementById("z2_04").style.display="none";

	 }else{

			document.getElementById("y2_04").style.display="block";
			document.getElementById("z2_04").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[4].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[4].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[4].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[4].q2");
			...
			document.getElementById("q1_04").style.display="none";
			document.getElementById("q1_004").style.display="none";

			document.getElementById("q2_04").style.display="none";
		}
		else if(document.getElementById(id).value=="1"){
		...
		document.getElementById("inp_0154").style.display="none";
			...
			document.getElementById("q1_04").style.display="block";
			document.getElementById("q1_004").style.display="none";

			document.getElementById("q2_04").style.display="block";
	}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_0154").style.display="block";
			...
			document.getElementById("q1_04").style.display="none";
			document.getElementById("q1_004").style.display="block";
...
function writeSingleVar5(id){
    ...
    if(id=="inp_050"){
    	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[5].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[5].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[5].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[5].q2");
		...
		document.getElementById("inp_0155").style.display="none";
			...
			document.getElementById("q1_05").style.display="none";
			document.getElementById("q1_005").style.display="none";

			document.getElementById("q2_05").style.display="none";
		 ...
		 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_05").style.display="none";
			document.getElementById("z2_05").style.display="none";

	 }else{

			document.getElementById("y2_05").style.display="block";
			document.getElementById("z2_05").style.display="block";
	 }
		if(document.getElementById(id).value=="1"){
		...
		document.getElementById("inp_0155").style.display="none";
			...
			document.getElementById("q1_05").style.display="block";
			document.getElementById("q1_005").style.display="none";

			document.getElementById("q2_05").style.display="block";
		...
		document.getElementById("inp_0155").style.display="block";
			...
			document.getElementById("q1_05").style.display="none";
			document.getElementById("q1_005").style.display="block";
...
function writeSingleVar6(id){
    ...
    if(id=="inp_060"){
		 ...
		 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_06").style.display="none";
			document.getElementById("z2_06").style.display="none";

	 }else{

			document.getElementById("y2_06").style.display="block";
			document.getElementById("z2_06").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[6].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[6].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[6].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[6].q2");
		...
		document.getElementById("inp_0156").style.display="none";
			...
			document.getElementById("q1_06").style.display="none";
			document.getElementById("q1_006").style.display="none";

			document.getElementById("q2_06").style.display="none";
		...
		document.getElementById("inp_0156").style.display="none";
			...
			document.getElementById("q1_06").style.display="block";
			document.getElementById("q1_006").style.display="none";

			document.getElementById("q2_06").style.display="block";
		...
		document.getElementById("inp_0156").style.display="block";
			...
			document.getElementById("q1_06").style.display="none";
			document.getElementById("q1_006").style.display="block";
...
function writeSingleVar7(id){
    ...
    if(id=="inp_070"){
		 ...
		 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_07").style.display="none";
			document.getElementById("z2_07").style.display="none";

	 }else{

			document.getElementById("y2_07").style.display="block";
			document.getElementById("z2_07").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[7].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[7].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[7].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[7].q2");
		...
		document.getElementById("inp_0157").style.display="none";
			...
			document.getElementById("q1_07").style.display="none";
			document.getElementById("q1_007").style.display="none";

			document.getElementById("q2_07").style.display="none";
		...
		document.getElementById("inp_0157").style.display="none";
			...
			document.getElementById("q1_07").style.display="block";
			document.getElementById("q1_007").style.display="none";

			document.getElementById("q2_07").style.display="block";
		...
		document.getElementById("inp_0157").style.display="block";
			...
			document.getElementById("q1_07").style.display="none";
			document.getElementById("q1_007").style.display="block";
...
function writeSingleVar8(id){
    ...
    if(id=="inp_080"){
		 ...
		 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_08").style.display="none";
			document.getElementById("z2_08").style.display="none";

	 }else{

			document.getElementById("y2_08").style.display="block";
			document.getElementById("z2_08").style.display="block";
	 }
	    ...
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[8].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[8].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[8].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[8].q2");
		...
		document.getElementById("inp_0158").style.display="none";
			...
			document.getElementById("q1_08").style.display="none";
			document.getElementById("q1_008").style.display="none";

			document.getElementById("q2_08").style.display="none";
		...
		document.getElementById("inp_0158").style.display="none";
			...
			document.getElementById("q1_08").style.display="block";
			document.getElementById("q1_008").style.display="none";

			document.getElementById("q2_08").style.display="block";
		...
		document.getElementById("inp_0158").style.display="block";
			...
			document.getElementById("q1_08").style.display="none";
			document.getElementById("q1_008").style.display="block";
...
function writeSingleVar9(id){
    ...
    if(id=="inp_090"){
		 ...
		 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_09").style.display="none";
			document.getElementById("z2_09").style.display="none";

	 }else{

			document.getElementById("y2_09").style.display="block";
			document.getElementById("z2_09").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[9].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[9].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[9].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[9].q2");
		...
		document.getElementById("inp_0159").style.display="none";
			...
			document.getElementById("q1_09").style.display="none";
			document.getElementById("q1_009").style.display="none";

			document.getElementById("q2_09").style.display="none";
		...
		document.getElementById("inp_0159").style.display="none";
			...
			document.getElementById("q1_09").style.display="block";
			document.getElementById("q1_009").style.display="none";

			document.getElementById("q2_09").style.display="block";
		...
		document.getElementById("inp_0159").style.display="block";
			...
			document.getElementById("q1_09").style.display="none";
			document.getElementById("q1_009").style.display="block";
...
function writeSingleVar10(id){
    ...
    if(id=="inp_100"){
		 ...
		 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_10").style.display="none";
			document.getElementById("z2_10").style.display="none";

	 }else{

			document.getElementById("y2_10").style.display="block";
			document.getElementById("z2_10").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[10].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[10].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[10].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[10].q2");
		...
		document.getElementById("inp_01520").style.display="none";
			...
			document.getElementById("q1_10").style.display="none";
			document.getElementById("q1_010").style.display="none";

			document.getElementById("q2_10").style.display="none";
		...
		document.getElementById("inp_01520").style.display="none";
			...
			document.getElementById("q1_10").style.display="block";
			document.getElementById("q1_010").style.display="none";

			document.getElementById("q2_10").style.display="block";
		}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_01520").style.display="block";
			...
			document.getElementById("q1_10").style.display="none";
			document.getElementById("q1_010").style.display="block";
...
function writeSingleVar11(id){
    ...
    if(id=="inp_110"){
		 ...
		 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_11").style.display="none";
			document.getElementById("z2_11").style.display="none";

	 }else{

			document.getElementById("y2_11").style.display="block";
			document.getElementById("z2_11").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[11].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[11].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[11].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[11].q2");
		...
		document.getElementById("inp_01521").style.display="none";
			...
			document.getElementById("q1_11").style.display="none";
			document.getElementById("q1_011").style.display="none";

			document.getElementById("q2_11").style.display="none";
	}
		else if(document.getElementById(id).value=="1"){
		...
		document.getElementById("inp_01521").style.display="none";
			...
			document.getElementById("q1_11").style.display="block";
			document.getElementById("q1_011").style.display="none";

			document.getElementById("q2_11").style.display="block";
		...
		document.getElementById("inp_01521").style.display="block";
			...
			document.getElementById("q1_11").style.display="none";
			document.getElementById("q1_011").style.display="block";
...
function writeSingleVar12(id){
    ...
    if(id=="inp_120"){
		 ...
		 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_12").style.display="none";
			document.getElementById("z2_12").style.display="none";

	 }else{

			document.getElementById("y2_12").style.display="block";
			document.getElementById("z2_12").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[12].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[12].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[12].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[12].q2");
		...
		document.getElementById("inp_01522").style.display="none";
			...
			document.getElementById("q1_12").style.display="none";
			document.getElementById("q1_012").style.display="none";

			document.getElementById("q2_12").style.display="none";
		...
		document.getElementById("inp_01522").style.display="none";
			...
			document.getElementById("q1_12").style.display="block";
			document.getElementById("q1_012").style.display="none";

			document.getElementById("q2_12").style.display="block";
		...
		document.getElementById("inp_01522").style.display="block";
			...
			document.getElementById("q1_12").style.display="none";
			document.getElementById("q1_012").style.display="block";
...
function writeSingleVar13(id){
    ...
    if(id=="inp_130"){
    	 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_13").style.display="none";
			document.getElementById("z2_13").style.display="none";

	 }else{

			document.getElementById("y2_13").style.display="block";
			document.getElementById("z2_13").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[13].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[13].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[13].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[13].q2");
		...
		document.getElementById("inp_01523").style.display="none";
			...
			document.getElementById("q1_13").style.display="none";
			document.getElementById("q1_013").style.display="none";

			document.getElementById("q2_13").style.display="none";
	}
		else if(document.getElementById(id).value=="1"){
		...
		document.getElementById("inp_01523").style.display="none";
			...
			document.getElementById("q1_13").style.display="block";
			document.getElementById("q1_013").style.display="none";

			document.getElementById("q2_13").style.display="block";
	}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_01523").style.display="block";
			...
			document.getElementById("q1_13").style.display="none";
			document.getElementById("q1_013").style.display="block";
...
function writeSingleVar14(id){
    ...
    if(id=="inp_140"){
	 ...
	 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_14").style.display="none";
			document.getElementById("z2_14").style.display="none";

	 }else{

			document.getElementById("y2_14").style.display="block";
			document.getElementById("z2_14").style.display="block";
	 }
	     ...
	     if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[14].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[14].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[14].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[14].q2");
		...
		document.getElementById("inp_01524").style.display="none";
			...
			document.getElementById("q1_14").style.display="none";
			document.getElementById("q1_014").style.display="none";

			document.getElementById("q2_14").style.display="none";
		...
		document.getElementById("inp_01524").style.display="none";
			...
			document.getElementById("q1_14").style.display="block";
			document.getElementById("q1_014").style.display="none";

			document.getElementById("q2_14").style.display="block";
		...
		document.getElementById("inp_01524").style.display="block";
			...
			document.getElementById("q1_14").style.display="none";
			document.getElementById("q1_014").style.display="block";
...
function writeSingleVar15(id){
    ...
    if(id=="inp_150"){
    	 if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_15").style.display="none";
			document.getElementById("z2_15").style.display="none";

	 }else{

			document.getElementById("y2_15").style.display="block";
			document.getElementById("z2_15").style.display="block";
	 }
	    ...
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[15].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[15].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[15].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[15].q2");
		...
		document.getElementById("inp_01525").style.display="none";
			...
			document.getElementById("q1_15").style.display="none";
			document.getElementById("q1_015").style.display="none";

			document.getElementById("q2_15").style.display="none";
		...
		document.getElementById("inp_01525").style.display="none";
			...
			document.getElementById("q1_15").style.display="block";
			document.getElementById("q1_015").style.display="none";

			document.getElementById("q2_15").style.display="block";
	}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_01525").style.display="block";
			...
			document.getElementById("q1_15").style.display="none";
			document.getElementById("q1_015").style.display="block";
...
function writeSingleVar16(id){
    ...
    if(id=="inp_160"){
			...
			document.getElementById("y2_16").style.display="none";
			document.getElementById("z2_16").style.display="none";

	 }else{

			document.getElementById("y2_16").style.display="block";
			document.getElementById("z2_16").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[16].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[16].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[16].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[16].q2");
		...
		document.getElementById("inp_01526").style.display="none";
			...
			document.getElementById("q1_16").style.display="none";
			document.getElementById("q1_016").style.display="none";

			document.getElementById("q2_16").style.display="none";
		...
		document.getElementById("inp_01526").style.display="none";
			...
			document.getElementById("q1_16").style.display="block";
			document.getElementById("q1_016").style.display="none";

			document.getElementById("q2_16").style.display="block";
	}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_01526").style.display="block";
			...
			document.getElementById("q1_16").style.display="none";
			document.getElementById("q1_016").style.display="block";
...
function writeSingleVar17(id){
    ...
    if(id=="inp_170"){
			...
			document.getElementById("y2_17").style.display="none";
			document.getElementById("z2_17").style.display="none";

	 }else{

			document.getElementById("y2_17").style.display="block";
			document.getElementById("z2_17").style.display="block";
	 }
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[17].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[17].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[17].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[17].q2");
		...
		document.getElementById("inp_01527").style.display="none";
			...
			document.getElementById("q1_17").style.display="none";
			document.getElementById("q1_017").style.display="none";

			document.getElementById("q2_17").style.display="none";
		...
		document.getElementById("inp_01527").style.display="none";
			...
			document.getElementById("q1_17").style.display="block";
			document.getElementById("q1_017").style.display="none";

			document.getElementById("q2_17").style.display="block";
	}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_01527").style.display="block";
			...
			document.getElementById("q1_17").style.display="none";
			document.getElementById("q1_017").style.display="block";
...
function writeSingleVar18(id){
    ...
    if(id=="inp_180"){
			...
			document.getElementById("y2_18").style.display="none";
			document.getElementById("z2_18").style.display="none";

	 }else{

			document.getElementById("y2_18").style.display="block";
			document.getElementById("z2_18").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[18].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[18].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[18].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[18].q2");
		...
		document.getElementById("inp_01528").style.display="none";
			...
			document.getElementById("q1_18").style.display="none";
			document.getElementById("q1_018").style.display="none";

			document.getElementById("q2_18").style.display="none";
		...
		document.getElementById("inp_01528").style.display="none";
			...
			document.getElementById("q1_18").style.display="block";
			document.getElementById("q1_018").style.display="none";

			document.getElementById("q2_18").style.display="block";
	}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_01528").style.display="block";
			...
			document.getElementById("q1_18").style.display="none";
			document.getElementById("q1_018").style.display="block";
...
function writeSingleVar19(id){
    ...
    if(id=="inp_190"){
			...
			document.getElementById("y2_19").style.display="none";
			document.getElementById("z2_19").style.display="none";

	 }else{

			document.getElementById("y2_19").style.display="block";
			document.getElementById("z2_19").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[19].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[19].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[19].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[19].q2");
		...
		document.getElementById("inp_01529").style.display="none";
			...
			document.getElementById("q1_19").style.display="none";
			document.getElementById("q1_019").style.display="none";

			document.getElementById("q2_19").style.display="none";
	}
		else if(document.getElementById(id).value=="1"){
		...
		document.getElementById("inp_01529").style.display="none";
			...
			document.getElementById("q1_19").style.display="block";
			document.getElementById("q1_019").style.display="none";

			document.getElementById("q2_19").style.display="block";
		...
		document.getElementById("inp_01529").style.display="block";
			...
			document.getElementById("q1_19").style.display="none";
			document.getElementById("q1_019").style.display="block";
...
function writeSingleVar20(id){
    ...
    if(id=="inp_200"){
    	if(document.getElementById(id).value!=="1"){
			...
			document.getElementById("y2_20").style.display="none";
			document.getElementById("z2_20").style.display="none";

	 }else{

			document.getElementById("y2_20").style.display="block";
			document.getElementById("z2_20").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[20].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[20].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[20].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[20].q2");
		...
		document.getElementById("inp_01530").style.display="none";
			...
			document.getElementById("q1_20").style.display="none";
			document.getElementById("q1_020").style.display="none";

			document.getElementById("q2_20").style.display="none";
		...
		document.getElementById("inp_01530").style.display="none";
			...
			document.getElementById("q1_20").style.display="block";
			document.getElementById("q1_020").style.display="none";

			document.getElementById("q2_20").style.display="block";
		...
		document.getElementById("inp_01530").style.display="block";
			...
			document.getElementById("q1_20").style.display="none";
			document.getElementById("q1_020").style.display="block";
...
function writeSingleVar21(id){
    ...
    if(id=="inp_210"){
			...
			document.getElementById("y2_21").style.display="none";
			document.getElementById("z2_21").style.display="none";

	 }else{

			document.getElementById("y2_21").style.display="block";
			document.getElementById("z2_21").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[21].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[21].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[21].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[21].q2");
		...
		document.getElementById("inp_01531").style.display="none";
			...
			document.getElementById("q1_21").style.display="none";
			document.getElementById("q1_021").style.display="none";

			document.getElementById("q2_21").style.display="none";
		...
		document.getElementById("inp_01531").style.display="none";
			...
			document.getElementById("q1_21").style.display="block";
			document.getElementById("q1_021").style.display="none";

			document.getElementById("q2_21").style.display="block";
	}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_01531").style.display="block";
			...
			document.getElementById("q1_21").style.display="none";
			document.getElementById("q1_021").style.display="block";
...
function writeSingleVar22(id){
    ...
    if(id=="inp_220"){
			...
			document.getElementById("y2_22").style.display="none";
			document.getElementById("z2_22").style.display="none";

	 }else{

			document.getElementById("y2_22").style.display="block";
			document.getElementById("z2_22").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[22].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[22].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[22].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[22].q2");
		...
		document.getElementById("inp_01532").style.display="none";
			...
			document.getElementById("q1_22").style.display="none";
			document.getElementById("q1_022").style.display="none";

			document.getElementById("q2_22").style.display="none";
		...
		document.getElementById("inp_01532").style.display="none";
			...
			document.getElementById("q1_22").style.display="block";
			document.getElementById("q1_022").style.display="none";

			document.getElementById("q2_22").style.display="block";
		...
		document.getElementById("inp_01532").style.display="block";
			...
			document.getElementById("q1_22").style.display="none";
			document.getElementById("q1_022").style.display="block";
...
function writeSingleVar23(id){
    ...
    if(id=="inp_230"){
			...
			document.getElementById("y2_23").style.display="none";
			document.getElementById("z2_23").style.display="none";

	 }else{

			document.getElementById("y2_23").style.display="block";
			document.getElementById("z2_23").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[23].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[23].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[23].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[23].q2");
		...
		document.getElementById("inp_01533").style.display="none";
			...
			document.getElementById("q1_23").style.display="none";
			document.getElementById("q1_023").style.display="none";

			document.getElementById("q2_23").style.display="none";
		...
		document.getElementById("inp_01533").style.display="none";
			...
			document.getElementById("q1_23").style.display="block";
			document.getElementById("q1_023").style.display="none";

			document.getElementById("q2_23").style.display="block";
		...
		document.getElementById("inp_01533").style.display="block";
			...
			document.getElementById("q1_23").style.display="none";
			document.getElementById("q1_023").style.display="block";
...
function writeSingleVar24(id){
    ...
    if(id=="inp_240"){
			...
			document.getElementById("y2_24").style.display="none";
			document.getElementById("z2_24").style.display="none";

	 }else{

			document.getElementById("y2_24").style.display="block";
			document.getElementById("z2_24").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[24].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[24].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[24].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[24].q2");
		...
		document.getElementById("inp_01534").style.display="none";
			...
			document.getElementById("q1_24").style.display="none";
			document.getElementById("q1_024").style.display="none";

			document.getElementById("q2_24").style.display="none";
		...
		document.getElementById("inp_01534").style.display="none";
			...
			document.getElementById("q1_24").style.display="block";
			document.getElementById("q1_024").style.display="none";

			document.getElementById("q2_24").style.display="block";
	}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_01534").style.display="block";
			...
			document.getElementById("q1_24").style.display="none";
			document.getElementById("q1_024").style.display="block";
...
function writeSingleVar25(id){
    ...
    if(id=="inp_250"){
			...
			document.getElementById("y2_25").style.display="none";
			document.getElementById("z2_25").style.display="none";

	 }else{

			document.getElementById("y2_25").style.display="block";
			document.getElementById("z2_25").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[25].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[25].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[25].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[25].q2");
		...
		document.getElementById("inp_01535").style.display="none";
			...
			document.getElementById("q1_25").style.display="none";
			document.getElementById("q1_025").style.display="none";

			document.getElementById("q2_25").style.display="none";
	}
		else if(document.getElementById(id).value=="1"){
		...
		document.getElementById("inp_01535").style.display="none";
			...
			document.getElementById("q1_25").style.display="block";
			document.getElementById("q1_025").style.display="none";

			document.getElementById("q2_25").style.display="block";
	}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_01535").style.display="block";
			...
			document.getElementById("q1_25").style.display="none";
			document.getElementById("q1_025").style.display="block";
...
function writeSingleVar26(id){
    ...
    if(id=="inp_260"){
			...
			document.getElementById("y2_26").style.display="none";
			document.getElementById("z2_26").style.display="none";

	 }else{

			document.getElementById("y2_26").style.display="block";
			document.getElementById("z2_26").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[26].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[26].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[26].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[26].q2");
		...
		document.getElementById("inp_01536").style.display="none";
			...
			document.getElementById("q1_26").style.display="none";
			document.getElementById("q1_026").style.display="none";

			document.getElementById("q2_26").style.display="none";
	}
		else if(document.getElementById(id).value=="1"){
		...
		document.getElementById("inp_01536").style.display="none";
			...
			document.getElementById("q1_26").style.display="block";
			document.getElementById("q1_026").style.display="none";

			document.getElementById("q2_26").style.display="block";
	}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_01536").style.display="block";
			...
			document.getElementById("q1_26").style.display="none";
			document.getElementById("q1_026").style.display="block";
...
function writeSingleVar27(id){
    ...
    if(id=="inp_270"){
			...
			document.getElementById("y2_27").style.display="none";
			document.getElementById("z2_27").style.display="none";

	 }else{

			document.getElementById("y2_27").style.display="block";
			document.getElementById("z2_27").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[27].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[27].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[27].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[27].q2");
		...
		document.getElementById("inp_01537").style.display="none";
			...
			document.getElementById("q1_27").style.display="none";
			document.getElementById("q1_027").style.display="none";

			document.getElementById("q2_27").style.display="none";
	}
		else if(document.getElementById(id).value=="1"){
		...
		document.getElementById("inp_01537").style.display="none";
			...
			document.getElementById("q1_27").style.display="block";
			document.getElementById("q1_027").style.display="none";

			document.getElementById("q2_27").style.display="block";
	}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_01537").style.display="block";
			...
			document.getElementById("q1_27").style.display="none";
			document.getElementById("q1_027").style.display="block";
...
function writeSingleVar28(id){
    ...
    if(id=="inp_280"){
			...
			document.getElementById("y2_28").style.display="none";
			document.getElementById("z2_28").style.display="none";

	 }else{

			document.getElementById("y2_28").style.display="block";
			document.getElementById("z2_28").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[28].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[28].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[28].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[28].q2");
		...
		document.getElementById("inp_01538").style.display="none";
			...
			document.getElementById("q1_28").style.display="none";
			document.getElementById("q1_028").style.display="none";

			document.getElementById("q2_28").style.display="none";
		...
		document.getElementById("inp_01538").style.display="none";
			...
			document.getElementById("q1_28").style.display="block";
			document.getElementById("q1_028").style.display="none";

			document.getElementById("q2_28").style.display="block";
	}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_01538").style.display="block";
			...
			document.getElementById("q1_28").style.display="none";
			document.getElementById("q1_028").style.display="block";
...
function writeSingleVar29(id){
    ...
    if(id=="inp_290"){
			...
			document.getElementById("y2_29").style.display="none";
			document.getElementById("z2_29").style.display="none";

	 }else{

			document.getElementById("y2_29").style.display="block";
			document.getElementById("z2_29").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[29].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[29].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[29].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[29].q2");
		...
		document.getElementById("inp_01539").style.display="none";
			...
			document.getElementById("q1_29").style.display="none";
			document.getElementById("q1_029").style.display="none";

			document.getElementById("q2_29").style.display="none";
	}
		else if(document.getElementById(id).value=="1"){
		...
		document.getElementById("inp_01539").style.display="none";
			...
			document.getElementById("q1_29").style.display="block";
			document.getElementById("q1_029").style.display="none";

			document.getElementById("q2_29").style.display="block";
	}
		else if(document.getElementById(id).value=="4"){
		...
		document.getElementById("inp_01539").style.display="block";
			...
			document.getElementById("q1_29").style.display="none";
			document.getElementById("q1_029").style.display="block";
...
function writeSingleVar30(id){
    ...
    if(id=="inp_300"){
			...
			document.getElementById("y2_30").style.display="none";
			document.getElementById("z2_30").style.display="none";

	 }else{

			document.getElementById("y2_30").style.display="block";
			document.getElementById("z2_30").style.display="block";
	 }
	    if(document.getElementById(id).value=="0"){
		     ...
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[30].y2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[30].z2");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[30].q1");
		     writeValueFN("0", "unit/dHdGlobal.gsHMIdata.sStep[30].q2");
		...
		document.getElementById("inp_01540").style.display="none";
			...
			document.getElementById("q1_30").style.display="none";
			document.getElementById("q1_030").style.display="none";

			document.getElementById("q2_30").style.display="none";
	}
		else if(document.getElementById(id).value=="1"){
		...
		document.getElementById("inp_01540").style.display="none";
			...
			document.getElementById("q1_30").style.display="block";
			document.getElementById("q1_030").style.display="none";

			document.getElementById("q2_30").style.display="block";
		...
		document.getElementById("inp_01540").style.display="block";
			...
			document.getElementById("q1_30").style.display="none";
			document.getElementById("q1_030").style.display="block";
...
var id_輸出訊號=["inp_0151","inp_0152","inp_0153","inp_0154","inp_0155","inp_0156","inp_0157","inp_0158","inp_0159","inp_01520","inp_01521","inp_01522","inp_01523","inp_01524","inp_01525","inp_01526","inp_01527","inp_01528","inp_01529","inp_01530","inp_01531","inp_01532","inp_01533","inp_01534","inp_01535","inp_01536","inp_01537","inp_01538","inp_01539","inp_01540"]
var var_輸出訊號=["unit/dHdGlobal.gsHMIdata.sStep[1].P1","unit/dHdGlobal.gsHMIdata.sStep[2].P1","unit/dHdGlobal.gsHMIdata.sStep[3].P1","unit/dHdGlobal.gsHMIdata.sStep[4].P1","unit/dHdGlobal.gsHMIdata.sStep[5].P1","unit/dHdGlobal.gsHMIdata.sStep[6].P1","unit/dHdGlobal.gsHMIdata.sStep[7].P1","unit/dHdGlobal.gsHMIdata.sStep[8].P1","unit/dHdGlobal.gsHMIdata.sStep[9].P1","unit/dHdGlobal.gsHMIdata.sStep[10].P1","unit/dHdGlobal.gsHMIdata.sStep[11].P1","unit/dHdGlobal.gsHMIdata.sStep[12].P1","unit/dHdGlobal.gsHMIdata.sStep[13].P1","unit/dHdGlobal.gsHMIdata.sStep[14].P1","unit/dHdGlobal.gsHMIdata.sStep[15].P1","unit/dHdGlobal.gsHMIdata.sStep[16].P1","unit/dHdGlobal.gsHMIdata.sStep[17].P1
...
///////////右方按鈕上//寧波要他相反過來
document.getElementById("btn_Y2Z2_down").addEventListener('mousedown',btndownf21,false);
document.getElementById("btn_Y2Z2_down").addEventListener('mouseup',btndownf22,false);

document.getElementById("btn_Y2Z2_down").addEventListener('touchstart',btndownf21,false);

document.getElementById("btn_Y2Z2_down").addEventListener('touchend',btndownf22,false);
///////////右方按鈕左
document.getElementById("btn_Y2Z2_left").addEventListener('mousedown',btnleftf21,false);
document.getElementById("btn_Y2Z2_left").addEventListener('mouseup',btnleftf22,false);

document.getElementById("btn_Y2Z2_left").addEventListener('touchstart',btnleftf21,false);

document.getElementById("btn_Y2Z2_left").addEventListener('touchend',btnleftf22,false);
///////////右方按鈕下//寧波要他相反過來
document.getElementById("btn_Y2Z2_up").addEventListener('mousedown',btnupf21,false);
document.getElementById("btn_Y2Z2_up").addEventListener('mouseup',btnupf22,false);

document.getElementById("btn_Y2Z2_up").addEventListener('touchstart',btnupf21,false);

document.getElementById("btn_Y2Z2_up").addEventListener('touchend',btnupf22,false);
///////////右方按鈕右
document.getElementById("btn_Y2Z2_right").addEventListener('mousedown',btnrightf21,false);
document.getElementById("btn_Y2Z2_right").addEventListener('mouseup',
	btnrightf22,false);

document.getElementById("btn_Y2Z2_right").addEventListener('touchstart',btnrightf21,false);

document.getElementById("btn_Y2Z2_right").addEventListener('touchend',btnrightf22,false);




///////////右方按鈕上
	function btnupf21(id){

		document.getElementById("btn_Y2Z2_up").style.background="url(../image/bg_BtnDown_top.png)";
		writeValueFN("true", "unit/xPTemplAxisFB.gashmidata[4].bojognegative");

		};

		function btnupf22(id){ 
		
		document.getElementById("btn_Y2Z2_up").style.background="url(../image/bg_BtnUp_top.png)";
		writeValueFN("false", "unit/xPTemplAxisFB.gashmidata[4].bojognegative");
		
	};
///////////右方按鈕左
function btnleftf21(id){

		document.getElementById("btn_Y2Z2_left").style.background="url(../image/bg_BtnDown_left.png)";
		writeValueFN("true", "unit/xPTemplAxisFB.gashmidata[3].bojognegative");

		};

		function btnleftf22(id){ 
		
		document.getElementById("btn_Y2Z2_left").style.background="url(../image/bg_BtnUp_left.png)";
		writeValueFN("false", "unit/xPTemplAxisFB.gashmidata[3].bojognegative");
		
	};
///////////右方按鈕下
function btndownf21(id){

		document.getElementById("btn_Y2Z2_down").style.background="url(../image/bg_BtnDown_bottom.png)";
		writeValueFN("true", "unit/xPTemplAxisFB.gashmidata[4].bojogpositiv");

		};

		function btndownf22(id){ 
		
		document.getElementById("btn_Y2Z2_down").style.background="url(../image/bg_BtnUp_bottom.png)";
		writeValueFN("false", "unit/xPTemplAxisFB.gashmidata[4].bojogpositiv");
		
	};
///////////右方按鈕右
function btnrightf21(id){

		document.getElementById("btn_Y2Z2_right").style.background="url(../image/bg_BtnDown_right.png)";
		writeValueFN("true", "unit/xPTemplAxisFB.gashmidata[3].bojogpositiv");

		};

		function btnrightf22(id){ 
		
		document.getElementById("btn_Y2Z2_right").style.background="url(../image/bg_BtnUp_right.png)";
		writeValueFN("false", "unit/xPTemplAxisFB.gashmidata[3].bojogpositiv");
