...
setInterval(function(){ReadValueShowAlarm("unit/dHdGlobal.gboAlarming")},1000)
...
document.getElementById('div_Toolbar').onmousedown = function () {
    _drag_init(this);
    };
...
var		VarName_AutoRefresh = ["unit/xPTemplAxisFB.gashmidata[0].saxisdata.sposdata.r32position",   //手动定位位置
								...
								"unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Y1pos",                            //最大工作位置Y1
								"unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Y1neg",                            //最小工作位置Y1
								"unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Z1pos",                            //最大工作位置Z1
								"unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Z1neg",
							    "unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Y2pos",
							    "unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Y2neg",
							    "unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Z2pos",
							    "unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Z2neg",
								];
...
var SubscriptionCycle = 250;///subscription讀取頻率
							...
							case "gboShow13":
							    {
							       Value = CurrentValues[i].mItemValue;
								    if (Value == "true") {
									document.getElementById("btn_Show13").value = "安全門";
							...
							case "gboShow18":
							    {
							       Value = CurrentValues[i].mItemValue;
								    if (Value == "true") {
									document.getElementById("btn_Show18").value = "機械手不操作";
	...
	var tmpReadCB = function(parResponse)
	{
		for (var tmpIndex = 0; tmpIndex < parResponse.length; tmpIndex++)
		{
			...
			{   switch(parseFloat(tmpValue).toFixed(2) % 11){
					case -1:
						document.getElementById(id[tmpIndex]).value="";
					break;
			        case 0:
...
function ReadValuePath(id, SimotionVariable) {
	...
	var tmpReadCB = function(parResponse)
	{
		for (var tmpIndex = 0; tmpIndex < parResponse.length; tmpIndex++)
		{
			...
			var tmpValue = (tmpItemValue.mItemValue) ? tmpItemValue.mItemValue : tmpItemValue.mItemResultId;
			//下面這行為將任何那列第二格沒字的話，將後面全部隱藏
		//console.log(document.getElementById(id[tmpIndex].substring(0, id[tmpIndex].length - 1)+"2").value);

			if(document.getElementById(id[tmpIndex]) != null&&document.getElementById(id[tmpIndex].substring(0, id[tmpIndex].length - 1)+"2").value!="")
			{   
				document.getElementById(id[tmpIndex]).value = parseFloat(tmpValue).toFixed(2);	
			}
...
/*
function test11(id, SimotionVariable,id_2) {
...
function ReadValueLine(id, SimotionVariable) 
{
			    ...
			    switch(tmpIndex % 7){//////////1除以7餘1
			        case 0: 
				        if(parseFloat(tmpValue).toFixed(2)==32){
				        	///////////移動
				        	if(id[tmpIndex]=="inp_010"){$("#inp_016").hide();$("#q2_01").hide();$("#y2_01").show();$("#z2_01").show();}
				        	if(id[tmpIndex]=="inp_020"){$("#inp_026").hide();$("#q2_02").hide();$("#y2_02").show();$("#z2_02").show();}
				        	if(id[tmpIndex]=="inp_030"){$("#inp_036").hide();$("#q2_03").hide();$("#y2_03").show();$("#z2_03").show();}
				        	if(id[tmpIndex]=="inp_040"){$("#inp_046").hide();$("#q2_04").hide();$("#y2_04").show();$("#z2_04").show();}
				        	if(id[tmpIndex]=="inp_050"){$("#inp_056").hide();$("#q2_05").hide();$("#y2_05").show();$("#z2_05").show();}
				        	if(id[tmpIndex]=="inp_060"){$("#inp_066").hide();$("#q2_06").hide();$("#y2_06").show();$("#z2_06").show();}
				        	if(id[tmpIndex]=="inp_070"){$("#inp_076").hide();$("#q2_07").hide();$("#y2_07").show();$("#z2_07").show();}
				        	if(id[tmpIndex]=="inp_080"){$("#inp_086").hide();$("#q2_08").hide();$("#y2_08").show();$("#z2_08").show();}
				        	if(id[tmpIndex]=="inp_090"){$("#inp_096").hide();$("#q2_09").hide();$("#y2_09").show();$("#z2_09").show();}
				        	if(id[tmpIndex]=="inp_100"){$("#inp_106").hide();$("#q2_10").hide();$("#y2_10").show();$("#z2_10").show();}
				        	if(id[tmpIndex]=="inp_110"){$("#inp_116").hide();$("#q2_11").hide();$("#y2_11").show();$("#z2_11").show();}
				        	if(id[tmpIndex]=="inp_120"){$("#inp_126").hide();$("#q2_12").hide();$("#y2_12").show();$("#z2_12").show();}
				        	if(id[tmpIndex]=="inp_130"){$("#inp_136").hide();$("#q2_13").hide();$("#y2_13").show();$("#z2_13").show();}
				        	if(id[tmpIndex]=="inp_140"){$("#inp_146").hide();$("#q2_14").hide();$("#y2_14").show();$("#z2_14").show();}
				        	if(id[tmpIndex]=="inp_150"){$("#inp_156").hide();$("#q2_15").hide();$("#y2_15").show();$("#z2_15").show();}
				        	if(id[tmpIndex]=="inp_160"){$("#inp_166").hide();$("#q2_16").hide();$("#y2_16").show();$("#z2_16").show();}
				        	if(id[tmpIndex]=="inp_170"){$("#inp_176").hide();$("#q2_17").hide();$("#y2_17").show();$("#z2_17").show();}
				        	if(id[tmpIndex]=="inp_180"){$("#inp_186").hide();$("#q2_18").hide();$("#y2_18").show();$("#z2_18").show();}
				        	if(id[tmpIndex]=="inp_190"){$("#inp_196").hide();$("#q2_19").hide();$("#y2_19").show();$("#z2_19").show();}
				        	if(id[tmpIndex]=="inp_200"){$("#inp_206").hide();$("#q2_20").hide();$("#y2_20").show();$("#z2_20").show();}
				        	if(id[tmpIndex]=="inp_210"){$("#inp_216").hide();$("#q2_21").hide();$("#y2_21").show();$("#z2_21").show();}
				        	if(id[tmpIndex]=="inp_220"){$("#inp_226").hide();$("#q2_22").hide();$("#y2_22").show();$("#z2_22").show();}
				        	if(id[tmpIndex]=="inp_230"){$("#inp_236").hide();$("#q2_23").hide();$("#y2_23").show();$("#z2_23").show();}
				        	if(id[tmpIndex]=="inp_240"){$("#inp_246").hide();$("#q2_24").hide();$("#y2_24").show();$("#z2_24").show();}
				        	if(id[tmpIndex]=="inp_250"){$("#inp_256").hide();$("#q2_25").hide();$("#y2_25").show();$("#z2_25").show();}
				        	if(id[tmpIndex]=="inp_260"){$("#inp_266").hide();$("#q2_26").hide();$("#y2_26").show();$("#z2_26").show();}
				        	if(id[tmpIndex]=="inp_270"){$("#inp_276").hide();$("#q2_27").hide();$("#y2_27").show();$("#z2_27").show();}
				        	if(id[tmpIndex]=="inp_280"){$("#inp_286").hide();$("#q2_28").hide();$("#y2_28").show();$("#z2_28").show();}
				        	if(id[tmpIndex]=="inp_290"){$("#inp_296").hide();$("#q2_29").hide();$("#y2_29").show();$("#z2_29").show();}
				        	if(id[tmpIndex]=="inp_300"){$("#inp_306").hide();$("#q2_30").hide();$("#y2_30").show();$("#z2_30").show();}
				            ...
				            document.getElementById(id[tmpIndex]).value="1";
 							...
 							/////////延遲時間
				        	if(id[tmpIndex]=="inp_010"){$("#inp_011").hide();$("#inp_012").hide();$("#inp_013").hide();$("#inp_014").hide();$("#inp_016").hide();$("#q2_01").hide();}
							if(id[tmpIndex]=="inp_020"){$("#inp_021").hide();$("#inp_022").hide();$("#inp_023").hide();$("#inp_024").hide();$("#inp_026").hide();$("#q2_02").hide();}
							if(id[tmpIndex]=="inp_030"){$("#inp_031").hide();$("#inp_032").hide();$("#inp_033").hide();$("#inp_034").hide();$("#inp_036").hide();$("#q2_03").hide();}
							if(id[tmpIndex]=="inp_040"){$("#inp_041").hide();$("#inp_042").hide();$("#inp_043").hide();$("#inp_044").hide();$("#inp_046").hide();$("#q2_04").hide();}
							if(id[tmpIndex]=="inp_050"){$("#inp_051").hide();$("#inp_052").hide();$("#inp_053").hide();$("#inp_054").hide();$("#inp_056").hide();$("#q2_05").hide();}
							if(id[tmpIndex]=="inp_060"){$("#inp_061").hide();$("#inp_062").hide();$("#inp_063").hide();$("#inp_064").hide();$("#inp_066").hide();$("#q2_06").hide();}
				            if(id[tmpIndex]=="inp_070"){$("#inp_071").hide();$("#inp_072").hide();$("#inp_073").hide();$("#inp_074").hide();$("#inp_076").hide();$("#q2_07").hide();}
				            if(id[tmpIndex]=="inp_080"){$("#inp_081").hide();$("#inp_082").hide();$("#inp_083").hide();$("#inp_084").hide();$("#inp_086").hide();$("#q2_08").hide();}
				            if(id[tmpIndex]=="inp_090"){$("#inp_091").hide();$("#inp_092").hide();$("#inp_093").hide();$("#inp_094").hide();$("#inp_096").hide();$("#q2_09").hide();}
				            if(id[tmpIndex]=="inp_100"){$("#inp_101").hide();$("#inp_102").hide();$("#inp_103").hide();$("#inp_104").hide();$("#inp_106").hide();$("#q2_10").hide();}
				            if(id[tmpIndex]=="inp_110"){$("#inp_111").hide();$("#inp_112").hide();$("#inp_113").hide();$("#inp_114").hide();$("#inp_116").hide();$("#q2_11").hide();}
				            if(id[tmpIndex]=="inp_120"){$("#inp_121").hide();$("#inp_122").hide();$("#inp_123").hide();$("#inp_124").hide();$("#inp_126").hide();$("#q2_12").hide();}
				            if(id[tmpIndex]=="inp_130"){$("#inp_131").hide();$("#inp_132").hide();$("#inp_133").hide();$("#inp_134").hide();$("#inp_136").hide();$("#q2_13").hide();}
				            if(id[tmpIndex]=="inp_140"){$("#inp_141").hide();$("#inp_142").hide();$("#inp_143").hide();$("#inp_144").hide();$("#inp_146").hide();$("#q2_14").hide();}
				            if(id[tmpIndex]=="inp_150"){$("#inp_151").hide();$("#inp_152").hide();$("#inp_153").hide();$("#inp_154").hide();$("#inp_156").hide();$("#q2_15").hide();}
				            if(id[tmpIndex]=="inp_160"){$("#inp_161").hide();$("#inp_162").hide();$("#inp_163").hide();$("#inp_164").hide();$("#inp_166").hide();$("#q2_16").hide();}
				            if(id[tmpIndex]=="inp_170"){$("#inp_171").hide();$("#inp_172").hide();$("#inp_173").hide();$("#inp_174").hide();$("#inp_176").hide();$("#q2_17").hide();}
				            if(id[tmpIndex]=="inp_180"){$("#inp_181").hide();$("#inp_182").hide();$("#inp_183").hide();$("#inp_184").hide();$("#inp_186").hide();$("#q2_18").hide();}
				            if(id[tmpIndex]=="inp_190"){$("#inp_191").hide();$("#inp_192").hide();$("#inp_193").hide();$("#inp_194").hide();$("#inp_196").hide();$("#q2_19").hide();}
				            if(id[tmpIndex]=="inp_200"){$("#inp_201").hide();$("#inp_202").hide();$("#inp_203").hide();$("#inp_204").hide();$("#inp_206").hide();$("#q2_20").hide();}
				            if(id[tmpIndex]=="inp_210"){$("#inp_211").hide();$("#inp_212").hide();$("#inp_213").hide();$("#inp_214").hide();$("#inp_216").hide();$("#q2_21").hide();}
				            if(id[tmpIndex]=="inp_220"){$("#inp_221").hide();$("#inp_222").hide();$("#inp_223").hide();$("#inp_224").hide();$("#inp_226").hide();$("#q2_22").hide();}
				            if(id[tmpIndex]=="inp_230"){$("#inp_231").hide();$("#inp_232").hide();$("#inp_233").hide();$("#inp_234").hide();$("#inp_236").hide();$("#q2_23").hide();}
				            if(id[tmpIndex]=="inp_240"){$("#inp_241").hide();$("#inp_242").hide();$("#inp_243").hide();$("#inp_244").hide();$("#inp_246").hide();$("#q2_24").hide();}
				            if(id[tmpIndex]=="inp_250"){$("#inp_251").hide();$("#inp_252").hide();$("#inp_253").hide();$("#inp_254").hide();$("#inp_256").hide();$("#q2_25").hide();}
				            if(id[tmpIndex]=="inp_260"){$("#inp_261").hide();$("#inp_262").hide();$("#inp_263").hide();$("#inp_264").hide();$("#inp_266").hide();$("#q2_26").hide();}
				            if(id[tmpIndex]=="inp_270"){$("#inp_271").hide();$("#inp_272").hide();$("#inp_273").hide();$("#inp_274").hide();$("#inp_276").hide();$("#q2_27").hide();}
				            if(id[tmpIndex]=="inp_280"){$("#inp_281").hide();$("#inp_282").hide();$("#inp_283").hide();$("#inp_284").hide();$("#inp_286").hide();$("#q2_28").hide();}
				            if(id[tmpIndex]=="inp_290"){$("#inp_291").hide();$("#inp_292").hide();$("#inp_293").hide();$("#inp_294").hide();$("#inp_296").hide();$("#q2_29").hide();}
				            if(id[tmpIndex]=="inp_300"){$("#inp_301").hide();$("#inp_302").hide();$("#inp_303").hide();$("#inp_304").hide();$("#inp_306").hide();$("#q2_30").hide();}
				            document.getElementById(id[tmpIndex]).value="2";
							
				        }
				        else if(parseFloat(tmpValue).toFixed(2)==24){
							if(id[tmpIndex]=="inp_010"){$("#inp_015").show();$("#inp_011").hide();$("#inp_012").hide();$("#inp_013").hide();$("#inp_014").hide();$("#q1_01").show();}
							if(id[tmpIndex]=="inp_020"){$("#inp_025").show();$("#inp_021").hide();$("#inp_022").hide();$("#inp_023").hide();$("#inp_024").hide();$("#q1_02").show();}
							if(id[tmpIndex]=="inp_030"){$("#inp_035").show();$("#inp_031").hide();$("#inp_032").hide();$("#inp_033").hide();$("#inp_034").hide();$("#q1_03").show();}
							if(id[tmpIndex]=="inp_040"){$("#inp_045").show();$("#inp_041").hide();$("#inp_042").hide();$("#inp_043").hide();$("#inp_044").hide();$("#q1_04").show();}
							if(id[tmpIndex]=="inp_050"){$("#inp_055").show();$("#inp_051").hide();$("#inp_052").hide();$("#inp_053").hide();$("#inp_054").hide();$("#q1_05").show();}
							if(id[tmpIndex]=="inp_060"){$("#inp_065").show();$("#inp_061").hide();$("#inp_062").hide();$("#inp_063").hide();$("#inp_064").hide();$("#q1_06").show();}
				            if(id[tmpIndex]=="inp_070"){$("#inp_075").show();$("#inp_071").hide();$("#inp_072").hide();$("#inp_073").hide();$("#inp_074").hide();$("#q1_07").show();}
				            if(id[tmpIndex]=="inp_080"){$("#inp_085").show();$("#inp_081").hide();$("#inp_082").hide();$("#inp_083").hide();$("#inp_084").hide();$("#q1_08").show();}
				            if(id[tmpIndex]=="inp_090"){$("#inp_095").show();$("#inp_091").hide();$("#inp_092").hide();$("#inp_093").hide();$("#inp_094").hide();$("#q1_09").show();}
				            if(id[tmpIndex]=="inp_100"){$("#inp_105").show();$("#inp_101").hide();$("#inp_102").hide();$("#inp_103").hide();$("#inp_104").hide();$("#q1_10").show();}
				            if(id[tmpIndex]=="inp_110"){$("#inp_115").show();$("#inp_111").hide();$("#inp_112").hide();$("#inp_113").hide();$("#inp_114").hide();$("#q1_11").show();}
				            if(id[tmpIndex]=="inp_120"){$("#inp_125").show();$("#inp_121").hide();$("#inp_122").hide();$("#inp_123").hide();$("#inp_124").hide();$("#q1_12").show();}
				            if(id[tmpIndex]=="inp_130"){$("#inp_135").show();$("#inp_131").hide();$("#inp_132").hide();$("#inp_133").hide();$("#inp_134").hide();$("#q1_13").show();}
				            if(id[tmpIndex]=="inp_140"){$("#inp_145").show();$("#inp_141").hide();$("#inp_142").hide();$("#inp_143").hide();$("#inp_144").hide();$("#q1_14").show();}
				            if(id[tmpIndex]=="inp_150"){$("#inp_155").show();$("#inp_151").hide();$("#inp_152").hide();$("#inp_153").hide();$("#inp_154").hide();$("#q1_15").show();}
				            if(id[tmpIndex]=="inp_160"){$("#inp_165").show();$("#inp_161").hide();$("#inp_162").hide();$("#inp_163").hide();$("#inp_164").hide();$("#q1_16").show();}
				            if(id[tmpIndex]=="inp_170"){$("#inp_175").show();$("#inp_171").hide();$("#inp_172").hide();$("#inp_173").hide();$("#inp_174").hide();$("#q1_17").show();}
				            if(id[tmpIndex]=="inp_180"){$("#inp_185").show();$("#inp_181").hide();$("#inp_182").hide();$("#inp_183").hide();$("#inp_184").hide();$("#q1_18").show();}
				            if(id[tmpIndex]=="inp_190"){$("#inp_195").show();$("#inp_191").hide();$("#inp_192").hide();$("#inp_193").hide();$("#inp_194").hide();$("#q1_19").show();}
				            if(id[tmpIndex]=="inp_200"){$("#inp_205").show();$("#inp_201").hide();$("#inp_202").hide();$("#inp_203").hide();$("#inp_204").hide();$("#q1_20").show();}
				            if(id[tmpIndex]=="inp_210"){$("#inp_215").show();$("#inp_211").hide();$("#inp_212").hide();$("#inp_213").hide();$("#inp_214").hide();$("#q1_21").show();}
				            if(id[tmpIndex]=="inp_220"){$("#inp_225").show();$("#inp_221").hide();$("#inp_222").hide();$("#inp_223").hide();$("#inp_224").hide();$("#q1_22").show();}
				            if(id[tmpIndex]=="inp_230"){$("#inp_235").show();$("#inp_231").hide();$("#inp_232").hide();$("#inp_233").hide();$("#inp_234").hide();$("#q1_23").show();}
				            if(id[tmpIndex]=="inp_240"){$("#inp_245").show();$("#inp_241").hide();$("#inp_242").hide();$("#inp_243").hide();$("#inp_244").hide();$("#q1_24").show();}
				            if(id[tmpIndex]=="inp_250"){$("#inp_255").show();$("#inp_251").hide();$("#inp_252").hide();$("#inp_253").hide();$("#inp_254").hide();$("#q1_25").show();}
				            if(id[tmpIndex]=="inp_260"){$("#inp_265").show();$("#inp_261").hide();$("#inp_262").hide();$("#inp_263").hide();$("#inp_264").hide();$("#q1_26").show();}
				            if(id[tmpIndex]=="inp_270"){$("#inp_275").show();$("#inp_271").hide();$("#inp_272").hide();$("#inp_273").hide();$("#inp_274").hide();$("#q1_27").show();}
				            if(id[tmpIndex]=="inp_280"){$("#inp_285").show();$("#inp_281").hide();$("#inp_282").hide();$("#inp_283").hide();$("#inp_284").hide();$("#q1_28").show();}
				            if(id[tmpIndex]=="inp_290"){$("#inp_295").show();$("#inp_291").hide();$("#inp_292").hide();$("#inp_293").hide();$("#inp_294").hide();$("#q1_29").show();}
				            if(id[tmpIndex]=="inp_300"){$("#inp_305").show();$("#inp_301").hide();$("#inp_302").hide();$("#inp_303").hide();$("#inp_304").hide();$("#q1_30").show();}
				            document.getElementById(id[tmpIndex]).value="3";
							
				        }
				        else if(parseFloat(tmpValue).toFixed(2)==66){
				            if(id[tmpIndex]=="inp_010"){$("#inp_0151").show();$("#inp_011").hide();$("#inp_012").hide();$("#inp_013").hide();$("#inp_014").hide();$("#q1_001").show();}
				            if(id[tmpIndex]=="inp_020"){$("#inp_0152").show();$("#inp_021").hide();$("#inp_022").hide();$("#inp_023").hide();$("#inp_024").hide();$("#q1_002").show();}
				            if(id[tmpIndex]=="inp_030"){$("#inp_0153").show();$("#inp_031").hide();$("#inp_032").hide();$("#inp_033").hide();$("#inp_034").hide();$("#q1_003").show();}
				            if(id[tmpIndex]=="inp_040"){$("#inp_0154").show();$("#inp_041").hide();$("#inp_042").hide();$("#inp_043").hide();$("#inp_044").hide();$("#q1_004").show();}
				            if(id[tmpIndex]=="inp_050"){$("#inp_0155").show();$("#inp_051").hide();$("#inp_052").hide();$("#inp_053").hide();$("#inp_054").hide();$("#q1_005").show();}
				            if(id[tmpIndex]=="inp_060"){$("#inp_0156").show();$("#inp_061").hide();$("#inp_062").hide();$("#inp_063").hide();$("#inp_064").hide();$("#q1_006").show();}
				            if(id[tmpIndex]=="inp_070"){$("#inp_0157").show();$("#inp_071").hide();$("#inp_072").hide();$("#inp_073").hide();$("#inp_074").hide();$("#q1_007").show();}
				            if(id[tmpIndex]=="inp_080"){$("#inp_0158").show();$("#inp_081").hide();$("#inp_082").hide();$("#inp_083").hide();$("#inp_084").hide();$("#q1_008").show();}
				            if(id[tmpIndex]=="inp_090"){$("#inp_0159").show();$("#inp_091").hide();$("#inp_092").hide();$("#inp_093").hide();$("#inp_094").hide();$("#q1_009").show();}
				            if(id[tmpIndex]=="inp_100"){$("#inp_01520").show();$("#inp_101").hide();$("#inp_102").hide();$("#inp_103").hide();$("#inp_104").hide();$("#q1_010").show();}
				            if(id[tmpIndex]=="inp_110"){$("#inp_01521").show();$("#inp_111").hide();$("#inp_112").hide();$("#inp_113").hide();$("#inp_114").hide();$("#q1_011").show();}
				            if(id[tmpIndex]=="inp_120"){$("#inp_01522").show();$("#inp_121").hide();$("#inp_122").hide();$("#inp_123").hide();$("#inp_124").hide();$("#q1_012").show();}
				            if(id[tmpIndex]=="inp_130"){$("#inp_01523").show();$("#inp_131").hide();$("#inp_132").hide();$("#inp_133").hide();$("#inp_134").hide();$("#q1_013").show();}
				            if(id[tmpIndex]=="inp_140"){$("#inp_01524").show();$("#inp_141").hide();$("#inp_142").hide();$("#inp_143").hide();$("#inp_144").hide();$("#q1_014").show();}
				            if(id[tmpIndex]=="inp_150"){$("#inp_01525").show();$("#inp_151").hide();$("#inp_152").hide();$("#inp_153").hide();$("#inp_154").hide();$("#q1_015").show();}
				            if(id[tmpIndex]=="inp_160"){$("#inp_01526").show();$("#inp_161").hide();$("#inp_162").hide();$("#inp_163").hide();$("#inp_164").hide();$("#q1_016").show();}
				            if(id[tmpIndex]=="inp_170"){$("#inp_01527").show();$("#inp_171").hide();$("#inp_172").hide();$("#inp_173").hide();$("#inp_174").hide();$("#q1_017").show();}
				            if(id[tmpIndex]=="inp_180"){$("#inp_01528").show();$("#inp_181").hide();$("#inp_182").hide();$("#inp_183").hide();$("#inp_184").hide();$("#q1_018").show();}
				            if(id[tmpIndex]=="inp_190"){$("#inp_01529").show();$("#inp_191").hide();$("#inp_192").hide();$("#inp_193").hide();$("#inp_194").hide();$("#q1_019").show();}
				            if(id[tmpIndex]=="inp_200"){$("#inp_01530").show();$("#inp_201").hide();$("#inp_202").hide();$("#inp_203").hide();$("#inp_204").hide();$("#q1_020").show();}
				            if(id[tmpIndex]=="inp_210"){$("#inp_01531").show();$("#inp_211").hide();$("#inp_212").hide();$("#inp_213").hide();$("#inp_214").hide();$("#q1_021").show();}
				            if(id[tmpIndex]=="inp_220"){$("#inp_01532").show();$("#inp_221").hide();$("#inp_222").hide();$("#inp_223").hide();$("#inp_224").hide();$("#q1_022").show();}
				            if(id[tmpIndex]=="inp_230"){$("#inp_01533").show();$("#inp_231").hide();$("#inp_232").hide();$("#inp_233").hide();$("#inp_234").hide();$("#q1_023").show();}
							if(id[tmpIndex]=="inp_240"){$("#inp_01534").show();$("#inp_241").hide();$("#inp_242").hide();$("#inp_243").hide();$("#inp_244").hide();$("#q1_024").show();}
							if(id[tmpIndex]=="inp_250"){$("#inp_01535").show();$("#inp_251").hide();$("#inp_252").hide();$("#inp_253").hide();$("#inp_254").hide();$("#q1_025").show();}
							if(id[tmpIndex]=="inp_260"){$("#inp_01536").show();$("#inp_261").hide();$("#inp_262").hide();$("#inp_263").hide();$("#inp_264").hide();$("#q1_026").show();}
							if(id[tmpIndex]=="inp_270"){$("#inp_01537").show();$("#inp_271").hide();$("#inp_272").hide();$("#inp_273").hide();$("#inp_274").hide();$("#q1_027").show();}
							if(id[tmpIndex]=="inp_280"){$("#inp_01538").show();$("#inp_281").hide();$("#inp_282").hide();$("#inp_283").hide();$("#inp_284").hide();$("#q1_028").show();}
							if(id[tmpIndex]=="inp_290"){$("#inp_01539").show();$("#inp_291").hide();$("#inp_292").hide();$("#inp_293").hide();$("#inp_294").hide();$("#q1_029").show();}
							if(id[tmpIndex]=="inp_300"){$("#inp_01540").show();$("#inp_301").hide();$("#inp_302").hide();$("#inp_303").hide();$("#inp_304").hide();$("#q1_030").show();}
                            ...
                            if(id[tmpIndex]=="inp_010"){$("#inp_011").hide();$("#inp_012").hide();$("#inp_013").hide();$("#inp_014").hide();$("#inp_016").hide();$("#inp_017").hide();$("#q2_01").hide();}
							if(id[tmpIndex]=="inp_020"){$("#inp_021").hide();$("#inp_022").hide();$("#inp_023").hide();$("#inp_024").hide();$("#inp_026").hide();$("#inp_027").hide();$("#q2_02").hide();}
							if(id[tmpIndex]=="inp_030"){$("#inp_031").hide();$("#inp_032").hide();$("#inp_033").hide();$("#inp_034").hide();$("#inp_036").hide();$("#inp_037").hide();$("#q2_03").hide();}
							if(id[tmpIndex]=="inp_040"){$("#inp_041").hide();$("#inp_042").hide();$("#inp_043").hide();$("#inp_044").hide();$("#inp_046").hide();$("#inp_047").hide();$("#q2_04").hide();}
							if(id[tmpIndex]=="inp_050"){$("#inp_051").hide();$("#inp_052").hide();$("#inp_053").hide();$("#inp_054").hide();$("#inp_056").hide();$("#inp_057").hide();$("#q2_05").hide();}
							if(id[tmpIndex]=="inp_060"){$("#inp_061").hide();$("#inp_062").hide();$("#inp_063").hide();$("#inp_064").hide();$("#inp_066").hide();$("#inp_067").hide();$("#q2_06").hide();}
				            if(id[tmpIndex]=="inp_070"){$("#inp_071").hide();$("#inp_072").hide();$("#inp_073").hide();$("#inp_074").hide();$("#inp_076").hide();$("#inp_077").hide();$("#q2_07").hide();}
				            if(id[tmpIndex]=="inp_080"){$("#inp_081").hide();$("#inp_082").hide();$("#inp_083").hide();$("#inp_084").hide();$("#inp_086").hide();$("#inp_087").hide();$("#q2_08").hide();}
				            if(id[tmpIndex]=="inp_090"){$("#inp_091").hide();$("#inp_092").hide();$("#inp_093").hide();$("#inp_094").hide();$("#inp_096").hide();$("#inp_097").hide();$("#q2_09").hide();}
				            if(id[tmpIndex]=="inp_100"){$("#inp_101").hide();$("#inp_102").hide();$("#inp_103").hide();$("#inp_104").hide();$("#inp_106").hide();$("#inp_107").hide();$("#q2_10").hide();}
				            if(id[tmpIndex]=="inp_110"){$("#inp_111").hide();$("#inp_112").hide();$("#inp_113").hide();$("#inp_114").hide();$("#inp_116").hide();$("#inp_117").hide();$("#q2_11").hide();}
				            if(id[tmpIndex]=="inp_120"){$("#inp_121").hide();$("#inp_122").hide();$("#inp_123").hide();$("#inp_124").hide();$("#inp_126").hide();$("#inp_127").hide();$("#q2_12").hide();}
				            if(id[tmpIndex]=="inp_130"){$("#inp_131").hide();$("#inp_132").hide();$("#inp_133").hide();$("#inp_134").hide();$("#inp_136").hide();$("#inp_137").hide();$("#q2_13").hide();}
				            if(id[tmpIndex]=="inp_140"){$("#inp_141").hide();$("#inp_142").hide();$("#inp_143").hide();$("#inp_144").hide();$("#inp_146").hide();$("#inp_147").hide();$("#q2_14").hide();}
				            if(id[tmpIndex]=="inp_150"){$("#inp_151").hide();$("#inp_152").hide();$("#inp_153").hide();$("#inp_154").hide();$("#inp_156").hide();$("#inp_157").hide();$("#q2_15").hide();}
				            if(id[tmpIndex]=="inp_160"){$("#inp_161").hide();$("#inp_162").hide();$("#inp_163").hide();$("#inp_164").hide();$("#inp_166").hide();$("#inp_167").hide();$("#q2_16").hide();}
				            if(id[tmpIndex]=="inp_170"){$("#inp_171").hide();$("#inp_172").hide();$("#inp_173").hide();$("#inp_174").hide();$("#inp_176").hide();$("#inp_177").hide();$("#q2_17").hide();}
				            if(id[tmpIndex]=="inp_180"){$("#inp_181").hide();$("#inp_182").hide();$("#inp_183").hide();$("#inp_184").hide();$("#inp_186").hide();$("#inp_187").hide();$("#q2_18").hide();}
				            if(id[tmpIndex]=="inp_190"){$("#inp_191").hide();$("#inp_192").hide();$("#inp_193").hide();$("#inp_194").hide();$("#inp_196").hide();$("#inp_197").hide();$("#q2_19").hide();}
				            if(id[tmpIndex]=="inp_200"){$("#inp_201").hide();$("#inp_202").hide();$("#inp_203").hide();$("#inp_204").hide();$("#inp_206").hide();$("#inp_207").hide();$("#q2_20").hide();}
				            if(id[tmpIndex]=="inp_210"){$("#inp_211").hide();$("#inp_212").hide();$("#inp_213").hide();$("#inp_214").hide();$("#inp_216").hide();$("#inp_217").hide();$("#q2_21").hide();}
				            if(id[tmpIndex]=="inp_220"){$("#inp_221").hide();$("#inp_222").hide();$("#inp_223").hide();$("#inp_224").hide();$("#inp_226").hide();$("#inp_227").hide();$("#q2_22").hide();}
				            if(id[tmpIndex]=="inp_230"){$("#inp_231").hide();$("#inp_232").hide();$("#inp_233").hide();$("#inp_234").hide();$("#inp_236").hide();$("#inp_237").hide();$("#q2_23").hide();}
				            if(id[tmpIndex]=="inp_240"){$("#inp_241").hide();$("#inp_242").hide();$("#inp_243").hide();$("#inp_244").hide();$("#inp_246").hide();$("#inp_247").hide();$("#q2_24").hide();}
				            if(id[tmpIndex]=="inp_250"){$("#inp_251").hide();$("#inp_252").hide();$("#inp_253").hide();$("#inp_254").hide();$("#inp_256").hide();$("#inp_257").hide();$("#q2_25").hide();}
				            if(id[tmpIndex]=="inp_260"){$("#inp_261").hide();$("#inp_262").hide();$("#inp_263").hide();$("#inp_264").hide();$("#inp_266").hide();$("#inp_267").hide();$("#q2_26").hide();}
				            if(id[tmpIndex]=="inp_270"){$("#inp_271").hide();$("#inp_272").hide();$("#inp_273").hide();$("#inp_274").hide();$("#inp_276").hide();$("#inp_277").hide();$("#q2_27").hide();}
				            if(id[tmpIndex]=="inp_280"){$("#inp_281").hide();$("#inp_282").hide();$("#inp_283").hide();$("#inp_284").hide();$("#inp_286").hide();$("#inp_287").hide();$("#q2_28").hide();}
				            if(id[tmpIndex]=="inp_290"){$("#inp_291").hide();$("#inp_292").hide();$("#inp_293").hide();$("#inp_294").hide();$("#inp_296").hide();$("#inp_297").hide();$("#q2_29").hide();}
				            if(id[tmpIndex]=="inp_300"){$("#inp_301").hide();$("#inp_302").hide();$("#inp_303").hide();$("#inp_304").hide();$("#inp_306").hide();$("#inp_307").hide();$("#q2_30").hide();}
	...
	if(id[tmpIndex]=="inp_010"){$("#q2_01").hide();}
if(id[tmpIndex]=="inp_020"){$("#q2_02").hide();   }
if(id[tmpIndex]=="inp_030"){ $("#q2_03").hide();    }
if(id[tmpIndex]=="inp_040"){  $("#q2_04").hide();   }
if(id[tmpIndex]=="inp_050"){  $("#q2_05").hide();   }
if(id[tmpIndex]=="inp_060"){   $("#q2_06").hide();  }
 if(id[tmpIndex]=="inp_070"){   $("#q2_07").hide();  }
 if(id[tmpIndex]=="inp_080"){   $("#q2_08").hide();  }
 if(id[tmpIndex]=="inp_090"){   $("#q2_09").hide();  }
 if(id[tmpIndex]=="inp_100"){   $("#q2_10").hide();  }
 if(id[tmpIndex]=="inp_110"){   $("#q2_11").hide();  }
 if(id[tmpIndex]=="inp_120"){   $("#q2_12").hide();  }
 if(id[tmpIndex]=="inp_130"){    $("#q2_13").hide(); }
 if(id[tmpIndex]=="inp_140"){   $("#q2_14").hide();  }
 if(id[tmpIndex]=="inp_150"){    $("#q2_15").hide(); }
 if(id[tmpIndex]=="inp_160"){  $("#q2_16").hide();   }
 if(id[tmpIndex]=="inp_170"){   $("#q2_17").hide();  }
 if(id[tmpIndex]=="inp_180"){   $("#q2_18").hide();  }
 if(id[tmpIndex]=="inp_190"){   $("#q2_19").hide();  }
 if(id[tmpIndex]=="inp_200"){  $("#q2_20").hide();   }
 if(id[tmpIndex]=="inp_210"){   $("#q2_21").hide();   }
 if(id[tmpIndex]=="inp_220"){   $("#q2_22").hide();   }
 if(id[tmpIndex]=="inp_230"){   $("#q2_23").hide();   }
 if(id[tmpIndex]=="inp_240"){   $("#q2_24").hide();   }
 if(id[tmpIndex]=="inp_250"){    $("#q2_25").hide();  }
 if(id[tmpIndex]=="inp_260"){    $("#q2_26").hide();  }
 if(id[tmpIndex]=="inp_270"){     $("#q2_27").hide(); }
 if(id[tmpIndex]=="inp_280"){    $("#q2_28").hide();  }
 if(id[tmpIndex]=="inp_290"){    $("#q2_29").hide();  }
 if(id[tmpIndex]=="inp_300"){    $("#q2_30").hide();  }
						}
					break;
				    case 1:///x
					    document.getElementById(id[tmpIndex]).value = parseFloat(tmpValue).toFixed(2);
...
function onChangeWriteValue(IdArray,varArray){

  for(i=0;i<IdArray.length;i++){

    document.getElementById(IdArray[i]).addEventListener('change',function(){
  //找出是idArray中第幾個index，對應到varArray
   var id = IdArray.indexOf(this.id);
  writeValueFN(this.value,varArray[id]);
  })
 }
}

function ReadSingleValue(SimotionVariable) {
    //測試用  用來讀取單一變量之值
    var tmpReadCB = function(parResponse)///////此為閉包
    {///伺服器回應parResponse
        for (var tmpIndex = 0; tmpIndex < parResponse.length; tmpIndex++)
    ...
    var tmpReadRequest = new OPCReadRequest("DE", tmpReadCB);
        ...
        tmpReadRequest.addItem("SIMOTION", SimotionVariable);
    
    tmpReadRequest.sendReadRequest();
};

function ReadValueShowAlarm(SimotionVariable) {
    //測試用  用來讀取單一變量之值
    var tmpReadCB = function(parResponse)///////此為閉包
    {///伺服器回應parResponse
        for (var tmpIndex = 0; tmpIndex < parResponse.length; tmpIndex++)
        {
            ...
            var tmpValue = (tmpItemValue.mItemValue) ? tmpItemValue.mItemValue : tmpItemValue.mItemResultId;
            if(tmpValue=="true"){
            document.getElementById('inp_Pose').value="警報產生"
            document.getElementById('inp_Pose').style.background="red"
        }else{

            document.getElementById('inp_Pose').value=""
            document.getElementById('inp_Pose').style.background=""
   		}	
        }
        return true;
...
function ReadValueCompilePath(id, SimotionVariable) {/////////函式一開始會先執行最下方sendReadRequest一次送完
	var tmpReadCB = function(parResponse)///////此為閉包
	{///伺服器回應parResponse
		for (var tmpIndex = 0; tmpIndex < parResponse.length; tmpIndex++)
		{
