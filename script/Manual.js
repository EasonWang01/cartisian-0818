$(document).ready(function(){
	document.getElementById('btn_X_Move').addEventListener('mousedown',function(){
		writeValueFN("true", "unit/xPTemplAxisFB.gashmidata[0].boexecutepos");

	})
		document.getElementById('btn_X_Move').addEventListener('mouseup',function(){
	...
	document.getElementById('btn_Y1_Move').addEventListener('mousedown',function(){
		writeValueFN("true", "unit/xPTemplAxisFB.gashmidata[1].boexecutepos");

	})
		document.getElementById('btn_Y1_Move').addEventListener('mouseup',function(){
	...
	document.getElementById('btn_Z1_Move').addEventListener('mousedown',function(){
		writeValueFN("true", "unit/xPTemplAxisFB.gashmidata[2].boexecutepos");

	})
		document.getElementById('btn_Z1_Move').addEventListener('mouseup',function(){
	...
	document.getElementById('btn_Y2_Move').addEventListener('mousedown',function(){
		writeValueFN("true", "unit/xPTemplAxisFB.gashmidata[3].boexecutepos");

	})
		document.getElementById('btn_Y2_Move').addEventListener('mouseup',function(){
		writeValueFN("false", "unit/xPTemplAxisFB.gashmidata[3].boexecutepos");
		writeValueFN("true", "unit/xPTemplAxisFB.gashmidata[3].boexecutestop");

	})



	document.getElementById('btn_Z2_Move').addEventListener('mousedown',function(){
		writeValueFN("true", "unit/xPTemplAxisFB.gashmidata[4].boexecutepos");

	})
		document.getElementById('btn_Z2_Move').addEventListener('mouseup',function(){
		writeValueFN("false", "unit/xPTemplAxisFB.gashmidata[4].boexecutepos");
		writeValueFN("true", "unit/xPTemplAxisFB.gashmidata[4].boexecutestop");
...
//Y1/Z1
    ...
    //Y2/Z2
    SubscriptionData.ItemList[SubscriptionData.LastIndex] = new Object();
    SubscriptionData.ItemList[SubscriptionData.LastIndex].id = "btn_Y2Z2_Horizontal";
    SubscriptionData.ItemList[SubscriptionData.LastIndex].style = "gboY2Z2_Horizontal";
    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemPath = "SIMOTION";
    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemName = "unit/dHdGlobal.gaboCondition[26]";
    SubscriptionData.LastIndex = SubscriptionData.LastIndex + 1;
	
	SubscriptionData.ItemList[SubscriptionData.LastIndex] = new Object();
    SubscriptionData.ItemList[SubscriptionData.LastIndex].id = "btn_Y2Z2_Vertical";
    SubscriptionData.ItemList[SubscriptionData.LastIndex].style = "gboY2Z2_Vertical";
    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemPath = "SIMOTION";
    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemName = "unit/dHdGlobal.gaboCondition[27]";
    SubscriptionData.LastIndex = SubscriptionData.LastIndex + 1;
	
	SubscriptionData.ItemList[SubscriptionData.LastIndex] = new Object();
    SubscriptionData.ItemList[SubscriptionData.LastIndex].id = "btn_Y2Z2_TopLine";
    SubscriptionData.ItemList[SubscriptionData.LastIndex].style = "gboY2Z2_TopLine";
    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemPath = "SIMOTION";
    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemName = "unit/dHdGlobal.gboNegLimitZ2";
    SubscriptionData.LastIndex = SubscriptionData.LastIndex + 1;
//型内、外限
    SubscriptionData.ItemList[SubscriptionData.LastIndex] = new Object();
...
//C轴
    ...
    SubscriptionData.ItemList[SubscriptionData.LastIndex].id = "inp_Y2_MovePistion";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].style = "default";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemPath = "SIMOTION";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemName = "unit/xPTemplAxisFB.gashmidata[3].saxisdata.sposdata.r32position";

    SubscriptionData.LastIndex = SubscriptionData.LastIndex + 1;

    SubscriptionData.ItemList[SubscriptionData.LastIndex] = new Object();

    SubscriptionData.ItemList[SubscriptionData.LastIndex].id = "inp_Z2_MovePistion";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].style = "default";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemPath = "SIMOTION";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemName = "unit/xPTemplAxisFB.gashmidata[4].saxisdata.sposdata.r32position";
